...
namespace EmployeeManagement.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        [HttpGet]
        [Authorize(Policy = "EditRolePolicy")] // This is a custom policy that we created in the Startup.cs file.
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted " +
                        ...
                        $"please remove the users from the role and then try to delete again.";
                    return View("Error");
                }
            }
        }
